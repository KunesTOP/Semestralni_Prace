...
{
    public class AnamnezaUrCujeNemocController //todo zkoukni radsi vsechny potom se bude urcovat smer tak na to jen mrkni kdyztak budou nejaky todo specificke vetsinou
    {
